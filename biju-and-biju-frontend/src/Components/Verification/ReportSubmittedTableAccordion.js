...
function ReportSubmittedTableAccordion(props) {
        ...
        <AccordionMain>
          ...
          <AccordionDetailsItem>
            ...
            <TypographyItem className="item">
              <Item>FI Type</Item>
              <Item className="value">
                {row.assign_verification_id.verification_address.fi_type}
              </Item>
            </TypographyItem>
            <TypographyItem className="item">
              <Item>
              ...
              <Item className="value">
                <span>
                  {extract_date(
                    row.assign_verification_id.verification_address.fi_date_time
                  )}
                  <p className="no-margin">
                    {get_time_from_date(
...
export default ReportSubmittedTableAccordion;
