...
function PV_VerificationForm(props) {
  console.log("PV_VerificationForm: ", props);
  return (
    <>
      ...
      <div className="section">
        <BorderItem>
          <ItemRow>
            <LabelSection>
              <Label>
                Rent(if rented,add rent per month also(Company Provided))
              </Label>
            </LabelSection>
            <ItemSection>
              <SpanValue>
...
export default PV_VerificationForm;
