...
import DatabaseSelectDownload from "./DatabaseSelectDownload";
import DatabaseEditModal from "./DatabaseEditModal";

function DatabaseTableAccordion(props) {
          ...
          <AccordionMain>
            ...
            <AccordionDetailsItem>
              ...
              <TypographyItem className="item">
                ...
                <Item className="value">{row.customer_number}</Item>
              </TypographyItem>
              <TypographyItem className="item">
                <Item>
                  Applicant
                ...
                <Item className="value">{row.applicant_type}</Item>
              </TypographyItem>
              <TypographyItem className="item">
                <Item>
              ...
              <TypographyItem className="item">
                <Item>RV Report Received Delay</Item>
                <Item className="value">
                  {rv?.verification_address[0]?.ver_recieved
                    ? timeDate(rv?.verification_address[0]?.ver_recieved)
                    : ""}
              ...
              <TypographyItem className="item">
                <Item>BV Report Received Delay</Item>
                <Item className="value">
                  {bv?.verification_address[0]?.ver_recieved
                    ? timeDate(bv?.verification_address[0]?.ver_recieved)
                    : ""}
              ...
              <TypographyItem className="item">
                <Item>PV Report Received Delay</Item>
                <Item className="value">
                  {pv?.verification_address[0]?.ver_recieved
                    ? timeDate(pv?.verification_address[0]?.ver_recieved)
                    : ""}
              ...
              <TypographyItem className="item">
                <Item>PD Report Received Delay</Item>
                <Item className="value">
                  {pd?.verification_address[0]?.ver_recieved
                    ? timeDate(pd?.verification_address[0]?.ver_recieved)
                    : ""}
...
export default DatabaseTableAccordion;
