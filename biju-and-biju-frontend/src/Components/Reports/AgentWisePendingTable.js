...
export default function AgentWisePendingTable(props) {
  ...
  const handleNavigate = (data) => {
    ...
    navigate(
      `/dashboard/agentwise-pending-district/${data.id}/${encodeURIComponent(
        data.name
      )}`
    );
  };
  ...
  return (
    <>
      ...
      <TableFooter>
        <ExportExcel
          fileName="Agent_Wise_Pending.xlsx"
          source="AGENT_WISE_PENDING"
