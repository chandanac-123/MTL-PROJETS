...
import { fetchExcelAgentWisePendingDistrictReport } from "../../Functions/helper";
import { ExportExcel } from "../ExportExcel";

export default function AgentWisePendingTableDistrict(props) {
  ...
  const handleNavigate = (data) => {
    navigate(
      `/dashboard/agentwise-pending-assigned-verification/${
        data.id
  ...
  return (
    <>
      ...
      <TableFooter>
        <ExportExcel
          fileName="Agent_Wise_Pending_district.xlsx"
          source="AGENT_WISE_USER"
