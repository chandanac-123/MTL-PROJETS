...
import { fetchExcelOfficeWiseVendorWiseReport } from "../../Functions/helper";
import { ExportExcel } from "../ExportExcel";

export default function VendorWisePendingTable(props) {
  ...
  const handleNavigate = (row) => {
    navigate(
      `/dashboard/vendorwise-pending/single/${row.id}/${encodeURIComponent(
        row.employee_name
      )}`
    );
  };
  ...
  return (
    <>
      ...
      <TableFooter>
        <ExportExcel
          fileName="vendorwise_pending.xlsx"
          source="VENDOR_WISE_PENDING"
