...
import TATReportProductTableAccordion from "./TATReportTables/TATReportProductTableAccordion";
...
export default function TATReportProductTable(props) {
  ...
  return (
    <>
      {isMobileScreen ? (
        <TATReportProductTableAccordion
          data={props?.data}
              ...
              <TableBody>
                {rows.map((row, index) => (
                  ...
                  >
                    ...
                    <TableCellDiv className="item">
                      {" "}
                      <LinkItem onClick={() => handleOpen(row.name)}>
                        {row.zero_1}
                      </LinkItem>
                    </TableCellDiv>
                    <TableCellDiv className="item">
