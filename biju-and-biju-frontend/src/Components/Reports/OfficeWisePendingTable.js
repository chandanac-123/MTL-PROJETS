...
export default function OfficeWisePendingTable(props) {
  ...
  const handleNavigate = (row) => {
    navigate(
      `/dashboard/officewise-pending/single/${row.id}/${encodeURIComponent(
        row.employee_name
  ...
  return (
    <>
      ...
      <TableFooter>
        <ExportExcel
          fileName="office_wise.xlsx"
          source="OFFICE_WISE_PENDING"
