...
function TATReportProductTableAccordion(props) {
  ...
  return (
    <>
        ...
        <AccordionMain>
          ...
          <AccordionDetailsItem>
            ...
            <TypographyItem className="item">
              <Item>0-1 HRS</Item>
              <Item className="value">
                <LinkItem onClick={() => props?.handleOpen(row.name)}>
                  {row.zero_1}
                </LinkItem>
              </Item>
            </TypographyItem>
            ...
            <TypographyItem className="item">
              <Item>Total</Item>
              <Item className="value">{row.total}</Item>
            </TypographyItem>
          </AccordionDetailsItem>
        </AccordionMain>
      ))}
      ...
      >
        <Box sx={style}>
          <TATDetails setOpen={props?.setOpen} />
        </Box>
      </Modal>
      <TablePaginationDemo
...
export default TATReportProductTableAccordion;
