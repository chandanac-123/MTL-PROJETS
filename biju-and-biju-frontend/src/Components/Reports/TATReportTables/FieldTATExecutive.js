...
import FieldTATExecutiveAccordion from "./FieldTATExecutiveAccordion";
...
export default function FieldTATExecutive(props) {
  ...
  useEffect(() => {
    async function fetchMyAPI() {
      ...
      if ((start !== null) & (end !== null)) {
        url =
          url +
          `&field_tat_duration__range=${start},${end}&assigned_verification_users__field_agent__id=${id}`;
      } else if (start !== null && end === null) {
        url =
          url +
          `&field_tat_duration__gte=${start}&assigned_verification_users__field_agent__id=${id}`;
      } else if ((start === null) & (end === null)) {
        url = url + `&assigned_verification_users__field_agent__id=${id}`;
      }
  ...
  const handleClick = () => {
    exportToExcel(props.data.results, "FieldTATFieldAgent");
  };

  const getItemValue = (item, name, fi_type = "") => {
    let result = "";
    if (name === "name") result = item.employee_name.toUpperCase();
  ...
  const searchParams = {
    ...
    assigned_verification_users__field_agent__id: detailID || undefined,
  ...
  return (
    <>
        ...
        <>
          <MainContainer component={Paper} isCollapse={isCollapse}>
            ...
            >
              <Box sx={style}>
                <TATDetails
                  name="FieldTATFieldAgentDetails"
                  setOpen={setOpen}
                  handleClose={handleClose}
                  data={detail_data}
                  count={totalPage}
      ...
      <TableFooter>
        <ExportExcel
          fileName="FieldTATFieldAgent.xlsx"
          source="FIELD_TAT_AGENT"
