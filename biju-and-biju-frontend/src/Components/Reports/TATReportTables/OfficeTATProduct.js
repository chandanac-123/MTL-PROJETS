...
import OfficeTATProductAccordion from "./OfficeTATProductAccordion";
...
export default function OfficeTATProduct(props) {
  ...
  useEffect(() => {
    async function fetchMyAPI() {
      ...
      if ((start !== null) & (end !== null)) {
        url =
          url +
          `&office_tat_duration__range=${start},${end}&verification_address__verification__product__id=${id}`;
      } else if (start !== null && end === null) {
        url =
          url +
          `&office_tat_duration__gte=${start}&verification_address__verification__product__id=${id}`;
      } else if ((start === null) & (end === null)) {
  ...
  const handleClick = () => {
    exportToExcel(props.data.results, "OfficeTATProduct");
  };
  ...
  const getItemValue = (item, name, fi_type = "") => {
    ...
    else if (name === "ten_twenty") result = item.ten_twenty;
    else if (name === "twenty_thirty") result = item.thirty_greater;
    else if (name === "thirty_greater") result = item.thirty_greater;
  ...
  return (
    <>
      ...
      <TableFooter>
        <ExportExcel
          fileName="OfficeTATProduct.xlsx"
          source="OFFICE_TAT_PRODUCT"
