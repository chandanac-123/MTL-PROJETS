...
function AssignTATDistrictAccordion(props) {
        ...
        <AccordionMain>
          ...
          <AccordionDetailsItem>
            ...
            <TypographyItem className="item">
              <Item>10-15 Min</Item>
              <Item className="value">
                <LinkItem onClick={() => props?.handleOpen(row.id, 600, 900)}>
                  {row.ten_fifteen}
                </LinkItem>
              </Item>
            </TypographyItem>
            <TypographyItem className="item">
              <Item>{"> 15 Min"}</Item>
              <Item className="value">
                <LinkItem onClick={() => props?.handleOpen(row.id, 900)}>
                  {row.fifteen_greater}
                </LinkItem>
              </Item>
            </TypographyItem>
...
export default AssignTATDistrictAccordion;
