...
function OfficeTATProductAccordion(props) {
        ...
        <AccordionMain>
          ...
          <AccordionDetailsItem>
            ...
            <TypographyItem className="item">
              <Item>0-10 MIN</Item>
              <Item className="value">
                <LinkItem onClick={() => props?.handleOpen(row.id, 0, 600)}>
                  {row.zero_ten}
                </LinkItem>
              </Item>
            </TypographyItem>
            <TypographyItem className="item">
              <Item>10-20 MIN</Item>
              <Item className="value">
                <LinkItem onClick={() => props?.handleOpen(row.id, 600, 1200)}>
                  {row.ten_twenty}
                </LinkItem>
              </Item>
            </TypographyItem>
            <TypographyItem className="item">
              <Item>20-30 MIN</Item>
              <Item className="value">
                <LinkItem onClick={() => props?.handleOpen(row.id, 1200, 1800)}>
                  {row.twenty_thirty}
                </LinkItem>
              </Item>
            </TypographyItem>
            <TypographyItem className="item">
              <Item>{"> 30 MIN"}</Item>
              <Item className="value">
                <LinkItem onClick={() => props?.handleOpen(row.id, 1800)}>
                  {row.thirty_greater}
                </LinkItem>
              </Item>
            </TypographyItem>
...
export default OfficeTATProductAccordion;
