...
function TotalTATDistrictAccordion(props) {
        ...
        <AccordionMain>
          ...
          <AccordionDetailsItem>
            ...
            <TypographyItem className="item">
              <Item>0-2 HRS</Item>
              <Item className="value">
                <LinkItem onClick={() => props?.handleOpen(row.id, 0, 7200)}>
                  {row.zero_two}
                </LinkItem>
              </Item>
            </TypographyItem>
            <TypographyItem className="item">
              <Item>2-3 HRS</Item>
              <Item className="value">
                <LinkItem onClick={() => props?.handleOpen(row.id, 7200.108)}>
                  {row.two_three}
                </LinkItem>
              </Item>
            </TypographyItem>
            ...
            <TypographyItem className="item">
              ...
              <Item className="value">
                <LinkItem
                  onClick={() => props?.handleOpen(row.id, 14400, 21600)}
                >
                  {row.four_six}
                </LinkItem>
              </Item>
            ...
            <TypographyItem className="item">
              ...
              <Item className="value">
                <LinkItem
                  onClick={() => props?.handleOpen(row.id, 21600, 28800)}
                >
                  {row.six_eight}
                </LinkItem>
              </Item>
            ...
            <TypographyItem className="item">
              <Item>{"> 8 HRS"}</Item>
              <Item className="value">
                <LinkItem onClick={() => props?.handleOpen(row.id, 28800)}>
                  {row.eight_greater}
                </LinkItem>
              </Item>
            </TypographyItem>
...
export default TotalTATDistrictAccordion;
