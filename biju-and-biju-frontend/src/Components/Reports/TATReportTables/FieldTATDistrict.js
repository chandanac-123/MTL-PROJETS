...
import FieldTATDistrictAccordion from "./FieldTATDistrictAccordion";
...
export default function FieldTATDistrict(props) {
  ...
  useEffect(() => {
    async function fetchMyAPI() {
      ...
      if ((start !== null) & (end !== null)) {
        url =
          url +
          `&field_tat_duration__range=${start},${end}&verification_address__adress_district__id=${id}`;
      } else if (start !== null && end === null) {
        url =
          url +
          `&field_tat_duration__gte=${start}&verification_address__adress_district__id=${id}`;
      } else if ((start === null) & (end === null)) {
  ...
  const handleClick = () => {
    exportToExcel(props.data.results, "FieldTATDistrict");
  };
  ...
  return (
    <>
      ...
      <TableFooter>
        <ExportExcel
          fileName="FieldTATDistrict.xlsx"
          source="FIELD_TAT_DISTRICT"
