...
import VendorBillingTable from "../../Components/VendorBillingParameter/VendorBillingTable";
import { vendor_billing_parameter } from "../../Api/VendorBillingParameterApis";
...
function VendorBillingParameter() {
  ...
  useEffect(() => {
    async function fetchMyAPI() {
      ...
      let url = vendor_billing_parameter;
      url = !state.searchValue
        ? vendor_billing_parameter + `?page=${page}&page_size=${pageSize}`
        : vendor_billing_parameter +
  ...
  if (loading) {
    ...
    return (
      <Container>
        <Heading name="Vendor Billing Parameters" />
        <SearchContainer>
          <TextInput
...
export default VendorBillingParameter;
